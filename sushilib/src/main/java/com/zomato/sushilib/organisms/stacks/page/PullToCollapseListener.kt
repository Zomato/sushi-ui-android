...
class PullToCollapseListener(context: Context, private val expandablePage: ExpandablePageLayout) :
        ...
        when (event.actionMasked) {
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                if (interceptedUntilNextGesture == null) {
                    val interceptResult =
                        expandablePage.handleOnPullToCollapseIntercept(event, downX, downY, deltaUpwardSwipe)
                    interceptedUntilNextGesture = interceptResult == true
    ...
    private fun dispatchPulledCallback(
        deltaY: Float,
        translationY: Float,
        upwardPull: Boolean,
        deltaUpwardPull: Boolean
